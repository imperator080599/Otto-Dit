...
>
> Engendré le 2026-09-06T12:25:59.413Z.
...
|---|---|---|---|---|
| `npm run db:reset` | vert | `0b1749f` (PAS le HEAD) | 2026-09-06T11:52:09Z | local, session Claude, chaîne verify complète (verify-full-4.log) — borne haute : vitest, l'étape suivante de la même chaîne ininterrompue, imprime elle-même « Start at 11:52:09 » ; HEAD déjà au SHA cité (commit 0b1749f à 11:49:33Z) quand la chaîne a démarré |
| `npm run demo:seed` | vert — « demo state ready — 13 exceptions, 8 deviations, 3 workpapers, 285 events » | `0b1749f` (PAS le HEAD) | 2026-09-06T11:52:09Z | local, session Claude, chaîne verify complète (verify-full-4.log), même borne haute que db:reset |
| `npx tsc --noEmit` | 0 erreur (aucune sortie — succès silencieux) | `0b1749f` (PAS le HEAD) | 2026-09-06T11:52:09Z | local, session Claude, chaîne verify complète (verify-full-4.log), même borne haute que db:reset |
| `npx vitest run` | 849/849, 100 fichiers — « Start at 11:52:09 », durée 336.36s (imprimé par vitest lui-même) | `0b1749f` (PAS le HEAD) | 2026-09-06T11:52:09Z | local, session Claude, chaîne verify complète (verify-full-4.log) |
| `npm run gardes` | vert — docs/GUARDS.md à jour, 43 garde(s) | `0b1749f` (PAS le HEAD) | 2026-09-06T12:15:34Z | local, session Claude, chaîne verify complète (verify-full-4.log) — borne haute : fin du journal (mtime du fichier), l'étape suit vitest sans interruption ; pas d'horodatage propre à cette étape |
| `npm run semeur` | vert — docs/SEMEUR_VS_CHEMIN.md à jour avec le registre (83 objets : 16 décors, 28 non prouvés, 39 prouvés) | `0b1749f` (PAS le HEAD) | 2026-09-06T12:15:34Z | local, session Claude, chaîne verify complète (verify-full-4.log), même borne haute que gardes |
| `npm run plancher` | vert — 849 test(s) collecté(s) par vitest · plancher 632 · aucune forme éteinte ou isolée | `0b1749f` (PAS le HEAD) | 2026-09-06T12:15:34Z | local, session Claude, chaîne verify complète (verify-full-4.log), même borne haute que gardes |
| `npm run langue` | vert — 0 chaîne hors catalogue, 0 libellé en dur dans un service | `0b1749f` (PAS le HEAD) | 2026-09-06T12:15:34Z | local, session Claude, chaîne verify complète (verify-full-4.log), même borne haute que gardes |
| `npm run langue:epreuve` | vert — 15/15 cas connus mauvais dénoncés | `0b1749f` (PAS le HEAD) | 2026-09-06T12:15:34Z | local, session Claude, chaîne verify complète (verify-full-4.log), même borne haute que gardes |
| `npm run lectures` | vert — 0 lecture perdue sur 1681 chemins figés dans 86 écrans | `0b1749f` (PAS le HEAD) | 2026-09-06T12:15:34Z | local, session Claude, chaîne verify complète (verify-full-4.log), même borne haute que gardes |
| `npm run lectures:epreuve` | vert — 6/6 cas connus mauvais dénoncés | `0b1749f` (PAS le HEAD) | 2026-09-06T12:15:34Z | local, session Claude, chaîne verify complète (verify-full-4.log), même borne haute que gardes |
| `npm run parcours` | vert — 244 station(s) déclarée(s), 244 figée(s), 0 station perdue | `0b1749f` (PAS le HEAD) | 2026-09-06T12:15:34Z | local, session Claude, chaîne verify complète (verify-full-4.log), même borne haute que gardes |
| `npm run parcours:epreuve` | vert — 5/5 cas connus mauvais dénoncés | `0b1749f` (PAS le HEAD) | 2026-09-06T12:15:34Z | local, session Claude, chaîne verify complète (verify-full-4.log), même borne haute que gardes |
| `npm run screens` | vert — 87 routes ouvertes, 0 échec (base locale, commande NUE, pas la variante screens:garde) | `0b1749f` (PAS le HEAD) | 2026-09-06T12:15:34Z | local, session Claude, chaîne verify complète (verify-full-4.log), même borne haute que gardes |
| `npm run fumee` | vert — 51 route(s) ouvertes sur http://localhost:3392, 0 échec (contre `next dev` en local, le maillon nu de la chaîne) | `0b1749f` (PAS le HEAD) | 2026-09-06T12:15:34Z | local, session Claude, chaîne verify complète (verify-full-4.log), même borne haute que gardes |
| `npm run densite` | vert — 77 écrans mesurés, 0 au-delà de 5 actions primaires, 108 champs à taper au total | `0b1749f` (PAS le HEAD) | 2026-09-06T12:15:34Z | local, session Claude, chaîne verify complète (verify-full-4.log), même borne haute que gardes |
| `npm run clics` | 202 étapes conduites · 0 échec(s) · 314 clics comptés sur 43 gestes · garde du parcours : 193 station(s) figée(s) vérifiée(s) · sonde d'hydratation : aucun incident — base fraîche, build de production | `0b1749f` (PAS le HEAD) | 2026-09-06T12:15:34Z | local, session Claude, chaîne verify complète (verify-full-4.log) ; CONFIRME sans nouveau figeage docs/PARCOURS.json, gelé par un run antérieur du même après-midi (commit fa47b36, 2026-09-06T10:47:30Z, mêmes chiffres) — ce run-ci ne l'a pas re-figé |
| `npm run visuel` | vert — 312 vues regardées (78 écrans × 4 vues), 0 défaut, build de PRODUCTION | `0b1749f` (PAS le HEAD) | 2026-09-06T12:15:34Z | local, session Claude, chaîne verify complète (verify-full-4.log) — mtime du journal, dernière ligne écrite avant EXIT_CODE=0 |

**Non exécutées sur le HEAD** (à passer avant de dire « vert », règle 12) :

- `npm run db:reset` — dernière exécution sur `0b1749f` le 2026-09-06T11:52:09Z : vert
- `npm run demo:seed` — dernière exécution sur `0b1749f` le 2026-09-06T11:52:09Z : vert — « demo state ready — 13 exceptions, 8 deviations, 3 workpapers, 285 events »
- `npx tsc --noEmit` — dernière exécution sur `0b1749f` le 2026-09-06T11:52:09Z : 0 erreur (aucune sortie — succès silencieux)
- `npx vitest run` — dernière exécution sur `0b1749f` le 2026-09-06T11:52:09Z : 849/849, 100 fichiers — « Start at 11:52:09 », durée 336.36s (imprimé par vitest lui-même)
- `npm run gardes` — dernière exécution sur `0b1749f` le 2026-09-06T12:15:34Z : vert — docs/GUARDS.md à jour, 43 garde(s)
- `npm run semeur` — dernière exécution sur `0b1749f` le 2026-09-06T12:15:34Z : vert — docs/SEMEUR_VS_CHEMIN.md à jour avec le registre (83 objets : 16 décors, 28 non prouvés, 39 prouvés)
- `npm run plancher` — dernière exécution sur `0b1749f` le 2026-09-06T12:15:34Z : vert — 849 test(s) collecté(s) par vitest · plancher 632 · aucune forme éteinte ou isolée
- `npm run langue` — dernière exécution sur `0b1749f` le 2026-09-06T12:15:34Z : vert — 0 chaîne hors catalogue, 0 libellé en dur dans un service
- `npm run langue:epreuve` — dernière exécution sur `0b1749f` le 2026-09-06T12:15:34Z : vert — 15/15 cas connus mauvais dénoncés
- `npm run lectures` — dernière exécution sur `0b1749f` le 2026-09-06T12:15:34Z : vert — 0 lecture perdue sur 1681 chemins figés dans 86 écrans
- `npm run lectures:epreuve` — dernière exécution sur `0b1749f` le 2026-09-06T12:15:34Z : vert — 6/6 cas connus mauvais dénoncés
- `npm run parcours` — dernière exécution sur `0b1749f` le 2026-09-06T12:15:34Z : vert — 244 station(s) déclarée(s), 244 figée(s), 0 station perdue
- `npm run parcours:epreuve` — dernière exécution sur `0b1749f` le 2026-09-06T12:15:34Z : vert — 5/5 cas connus mauvais dénoncés
- `npm run screens` — dernière exécution sur `0b1749f` le 2026-09-06T12:15:34Z : vert — 87 routes ouvertes, 0 échec (base locale, commande NUE, pas la variante screens:garde)
- `npm run fumee` — dernière exécution sur `0b1749f` le 2026-09-06T12:15:34Z : vert — 51 route(s) ouvertes sur http://localhost:3392, 0 échec (contre `next dev` en local, le maillon nu de la chaîne)
- `npm run densite` — dernière exécution sur `0b1749f` le 2026-09-06T12:15:34Z : vert — 77 écrans mesurés, 0 au-delà de 5 actions primaires, 108 champs à taper au total
- `npm run clics` — dernière exécution sur `0b1749f` le 2026-09-06T12:15:34Z : 202 étapes conduites · 0 échec(s) · 314 clics comptés sur 43 gestes · garde du parcours : 193 station(s) figée(s) vérifiée(s) · sonde d'hydratation : aucun incident — base fraîche, build de production
- `npm run visuel` — dernière exécution sur `0b1749f` le 2026-09-06T12:15:34Z : vert — 312 vues regardées (78 écrans × 4 vues), 0 défaut, build de PRODUCTION
