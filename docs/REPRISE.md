...
>
> Engendré le 2026-09-06T15:03:05.885Z.
...
- **HEAD** : `24a0319` — « Chaîne verify complète confirmée sur a46f4f5 (Lot 2, étape 1) : EXIT_CODE=0 »
...
- **SHA servi** : `24a0319` sur https://otto-dit.vercel.app, mesuré le 2026-09-06T15:01:22Z (il y a 0 h) par CI, travail `deploye`, run 34040786493, job 101507036353, étape « le SHA poussé doit être servi dans les 15 minutes » (conclusion success, 14:57:56Z→15:01:22Z) — scripts/deploiement/atteint.ts a vu l'instance servir le SHA poussé — **ÉGAL au HEAD**
...
|---|---|---|---|---|
| `npm run db:reset` | vert | `a46f4f5` (PAS le HEAD) | 2026-09-06T14:32:48Z | local, session Claude, chaîne verify complète (verify-full-6.log, Lot 2 étape 1 : détail du compte) — borne haute : vitest, l'étape suivante de la même chaîne ininterrompue, imprime elle-même « Start at 14:32:48 » ; HEAD déjà au SHA cité (commit a46f4f5 à 14:32:18Z) quand la chaîne a démarré |
| `npm run demo:seed` | vert | `a46f4f5` (PAS le HEAD) | 2026-09-06T14:32:48Z | local, session Claude, chaîne verify complète (verify-full-6.log, Lot 2 étape 1), même borne haute que db:reset |
| `npx tsc --noEmit` | 0 erreur (aucune sortie — succès silencieux) | `a46f4f5` (PAS le HEAD) | 2026-09-06T14:32:48Z | local, session Claude, chaîne verify complète (verify-full-6.log, Lot 2 étape 1), même borne haute que db:reset |
| `npx vitest run` | 852/852, 100 fichiers (+1 depuis 5c6b6a6 : la disambiguïsation par poste de derniereDemandeDetailDeCompte) — « Start at 14:32:48 » (imprimé par vitest lui-même) | `a46f4f5` (PAS le HEAD) | 2026-09-06T14:32:48Z | local, session Claude, chaîne verify complète (verify-full-6.log, Lot 2 étape 1) |
| `npm run gardes` | vert — docs/GUARDS.md à jour, 43 garde(s) | `a46f4f5` (PAS le HEAD) | 2026-09-06T14:56:19Z | local, session Claude, chaîne verify complète (verify-full-6.log, Lot 2 étape 1) — borne haute : mtime du journal (fin de chaîne), pas d'horodatage propre à cette étape |
| `npm run semeur` | vert — docs/SEMEUR_VS_CHEMIN.md à jour (83 objets : 16 décors, 28 non prouvés, 39 prouvés — inchangé, cette tranche ne sème rien) | `a46f4f5` (PAS le HEAD) | 2026-09-06T14:56:19Z | local, session Claude, chaîne verify complète (verify-full-6.log, Lot 2 étape 1), même borne haute que gardes |
| `npm run plancher` | vert — 852 test(s) collecté(s) · plancher 632 · aucune forme éteinte ou isolée | `a46f4f5` (PAS le HEAD) | 2026-09-06T14:56:19Z | local, session Claude, chaîne verify complète (verify-full-6.log, Lot 2 étape 1), même borne haute que gardes |
| `npm run langue` | vert — 0 chaîne hors catalogue, 0 libellé en dur dans un service | `a46f4f5` (PAS le HEAD) | 2026-09-06T14:56:19Z | local, session Claude, chaîne verify complète (verify-full-6.log, Lot 2 étape 1), même borne haute que gardes |
| `npm run langue:epreuve` | vert — 15/15 cas connus mauvais dénoncés | `a46f4f5` (PAS le HEAD) | 2026-09-06T14:56:19Z | local, session Claude, chaîne verify complète (verify-full-6.log, Lot 2 étape 1), même borne haute que gardes |
| `npm run lectures` | vert — 0 lecture perdue sur 1681 chemins figés dans 86 écrans | `a46f4f5` (PAS le HEAD) | 2026-09-06T14:56:19Z | local, session Claude, chaîne verify complète (verify-full-6.log, Lot 2 étape 1), même borne haute que gardes |
| `npm run lectures:epreuve` | vert — 6/6 cas connus mauvais dénoncés | `a46f4f5` (PAS le HEAD) | 2026-09-06T14:56:19Z | local, session Claude, chaîne verify complète (verify-full-6.log, Lot 2 étape 1), même borne haute que gardes |
| `npm run parcours` | vert — 246 station(s) déclarée(s) (+2 : la station « détail du compte »), 246 figée(s), 0 station perdue | `a46f4f5` (PAS le HEAD) | 2026-09-06T14:56:19Z | local, session Claude, chaîne verify complète (verify-full-6.log, Lot 2 étape 1), même borne haute que gardes |
| `npm run parcours:epreuve` | vert — 5/5 cas connus mauvais dénoncés | `a46f4f5` (PAS le HEAD) | 2026-09-06T14:56:19Z | local, session Claude, chaîne verify complète (verify-full-6.log, Lot 2 étape 1), même borne haute que gardes |
| `npm run screens` | vert — 87 routes ouvertes, 0 échec (base locale, commande NUE) | `a46f4f5` (PAS le HEAD) | 2026-09-06T14:56:19Z | local, session Claude, chaîne verify complète (verify-full-6.log, Lot 2 étape 1), même borne haute que gardes |
| `npm run fumee` | vert — 51 route(s) ouvertes sur http://localhost:3392, 0 échec (contre `next dev` en local, le maillon nu de la chaîne) | `a46f4f5` (PAS le HEAD) | 2026-09-06T14:56:19Z | local, session Claude, chaîne verify complète (verify-full-6.log, Lot 2 étape 1), même borne haute que gardes |
| `npm run densite` | vert — 77 écrans mesurés, 0 au-delà de 5 actions primaires, 108 champs à taper (sampling passe à 2 actions primaires, dans le seuil de 5) | `a46f4f5` (PAS le HEAD) | 2026-09-06T14:56:19Z | local, session Claude, chaîne verify complète (verify-full-6.log, Lot 2 étape 1), même borne haute que gardes |
| `npm run clics` | 204 étapes conduites (+2) · 0 échec(s) · 316 clics comptés sur 44 gestes · garde du parcours : 193 station(s) figée(s) vérifiée(s) · sonde d'hydratation : aucun incident — base fraîche, build de production | `a46f4f5` (PAS le HEAD) | 2026-09-06T14:56:19Z | local, session Claude, chaîne verify complète (verify-full-6.log, Lot 2 étape 1) |
| `npm run visuel` | vert — 312 vues regardées (78 écrans × 4 vues), 0 défaut, build de PRODUCTION (le nouveau panneau du sampling ne déborde nulle part) | `a46f4f5` (PAS le HEAD) | 2026-09-06T14:56:19Z | local, session Claude, chaîne verify complète (verify-full-6.log, Lot 2 étape 1) — mtime du journal, dernière ligne écrite avant EXIT_CODE=0 |

**Non exécutées sur le HEAD** (à passer avant de dire « vert », règle 12) :

- `npm run db:reset` — dernière exécution sur `a46f4f5` le 2026-09-06T14:32:48Z : vert
- `npm run demo:seed` — dernière exécution sur `a46f4f5` le 2026-09-06T14:32:48Z : vert
- `npx tsc --noEmit` — dernière exécution sur `a46f4f5` le 2026-09-06T14:32:48Z : 0 erreur (aucune sortie — succès silencieux)
- `npx vitest run` — dernière exécution sur `a46f4f5` le 2026-09-06T14:32:48Z : 852/852, 100 fichiers (+1 depuis 5c6b6a6 : la disambiguïsation par poste de derniereDemandeDetailDeCompte) — « Start at 14:32:48 » (imprimé par vitest lui-même)
- `npm run gardes` — dernière exécution sur `a46f4f5` le 2026-09-06T14:56:19Z : vert — docs/GUARDS.md à jour, 43 garde(s)
- `npm run semeur` — dernière exécution sur `a46f4f5` le 2026-09-06T14:56:19Z : vert — docs/SEMEUR_VS_CHEMIN.md à jour (83 objets : 16 décors, 28 non prouvés, 39 prouvés — inchangé, cette tranche ne sème rien)
- `npm run plancher` — dernière exécution sur `a46f4f5` le 2026-09-06T14:56:19Z : vert — 852 test(s) collecté(s) · plancher 632 · aucune forme éteinte ou isolée
- `npm run langue` — dernière exécution sur `a46f4f5` le 2026-09-06T14:56:19Z : vert — 0 chaîne hors catalogue, 0 libellé en dur dans un service
- `npm run langue:epreuve` — dernière exécution sur `a46f4f5` le 2026-09-06T14:56:19Z : vert — 15/15 cas connus mauvais dénoncés
- `npm run lectures` — dernière exécution sur `a46f4f5` le 2026-09-06T14:56:19Z : vert — 0 lecture perdue sur 1681 chemins figés dans 86 écrans
- `npm run lectures:epreuve` — dernière exécution sur `a46f4f5` le 2026-09-06T14:56:19Z : vert — 6/6 cas connus mauvais dénoncés
- `npm run parcours` — dernière exécution sur `a46f4f5` le 2026-09-06T14:56:19Z : vert — 246 station(s) déclarée(s) (+2 : la station « détail du compte »), 246 figée(s), 0 station perdue
- `npm run parcours:epreuve` — dernière exécution sur `a46f4f5` le 2026-09-06T14:56:19Z : vert — 5/5 cas connus mauvais dénoncés
- `npm run screens` — dernière exécution sur `a46f4f5` le 2026-09-06T14:56:19Z : vert — 87 routes ouvertes, 0 échec (base locale, commande NUE)
- `npm run fumee` — dernière exécution sur `a46f4f5` le 2026-09-06T14:56:19Z : vert — 51 route(s) ouvertes sur http://localhost:3392, 0 échec (contre `next dev` en local, le maillon nu de la chaîne)
- `npm run densite` — dernière exécution sur `a46f4f5` le 2026-09-06T14:56:19Z : vert — 77 écrans mesurés, 0 au-delà de 5 actions primaires, 108 champs à taper (sampling passe à 2 actions primaires, dans le seuil de 5)
- `npm run clics` — dernière exécution sur `a46f4f5` le 2026-09-06T14:56:19Z : 204 étapes conduites (+2) · 0 échec(s) · 316 clics comptés sur 44 gestes · garde du parcours : 193 station(s) figée(s) vérifiée(s) · sonde d'hydratation : aucun incident — base fraîche, build de production
- `npm run visuel` — dernière exécution sur `a46f4f5` le 2026-09-06T14:56:19Z : vert — 312 vues regardées (78 écrans × 4 vues), 0 défaut, build de PRODUCTION (le nouveau panneau du sampling ne déborde nulle part)
