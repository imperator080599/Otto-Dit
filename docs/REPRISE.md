...
>
> Engendré le 2026-09-07T02:30:20.537Z.
...
- **HEAD** : `f786fec` — « Chaîne verify confirmée pour R47 (9120af2) »
...
|---|---|---|---|---|
| `npm run db:reset` | vert — base réinitialisée, migrations appliquées | `9120af2` (PAS le HEAD) | 2026-09-07T02:20:35Z | local, session Claude, chaîne verify complète (verify-full-21.log, R47 — passage propre après les correctifs de la revue hostile ; verify-full-20.log avait rougi une fois sur clics, #418 hors tranche, non lié aux fichiers de cette tranche, F13 docs/CHASSE.md) — borne haute : mtime du journal (fin de chaîne), pas d'horodatage propre à cette étape |
| `npm run demo:seed` | vert — monde de démonstration reconstruit (13 exceptions, 8 deviations, 3 workpapers, 289 events) | `9120af2` (PAS le HEAD) | 2026-09-07T02:20:35Z | local, session Claude, chaîne verify complète (verify-full-21.log, R47 — passage propre après les correctifs de la revue hostile ; verify-full-20.log avait rougi une fois sur clics, #418 hors tranche, non lié aux fichiers de cette tranche, F13 docs/CHASSE.md) — borne haute : mtime du journal (fin de chaîne), pas d'horodatage propre à cette étape |
| `npx tsc --noEmit` | vert — aucune erreur de type | `9120af2` (PAS le HEAD) | 2026-09-07T02:20:35Z | local, session Claude, chaîne verify complète (verify-full-21.log, R47 — passage propre après les correctifs de la revue hostile ; verify-full-20.log avait rougi une fois sur clics, #418 hors tranche, non lié aux fichiers de cette tranche, F13 docs/CHASSE.md) — borne haute : mtime du journal (fin de chaîne), pas d'horodatage propre à cette étape |
| `npx vitest run` | vert — 102 fichier(s) de test, 860 test(s) passés (860) | `9120af2` (PAS le HEAD) | 2026-09-07T02:20:35Z | local, session Claude, chaîne verify complète (verify-full-21.log, R47 — passage propre après les correctifs de la revue hostile ; verify-full-20.log avait rougi une fois sur clics, #418 hors tranche, non lié aux fichiers de cette tranche, F13 docs/CHASSE.md) — borne haute : mtime du journal (fin de chaîne), pas d'horodatage propre à cette étape |
| `npm run gardes` | vert — docs/GUARDS.md à jour, 43 garde(s) | `9120af2` (PAS le HEAD) | 2026-09-07T02:20:35Z | local, session Claude, chaîne verify complète (verify-full-21.log, R47 — passage propre après les correctifs de la revue hostile ; verify-full-20.log avait rougi une fois sur clics, #418 hors tranche, non lié aux fichiers de cette tranche, F13 docs/CHASSE.md) — borne haute : mtime du journal (fin de chaîne), pas d'horodatage propre à cette étape |
| `npm run semeur` | vert — docs/SEMEUR_VS_CHEMIN.md à jour avec le registre | `9120af2` (PAS le HEAD) | 2026-09-07T02:20:35Z | local, session Claude, chaîne verify complète (verify-full-21.log, R47 — passage propre après les correctifs de la revue hostile ; verify-full-20.log avait rougi une fois sur clics, #418 hors tranche, non lié aux fichiers de cette tranche, F13 docs/CHASSE.md) — borne haute : mtime du journal (fin de chaîne), pas d'horodatage propre à cette étape |
| `npm run plancher` | vert — 860 test(s) collecté(s) par vitest, plancher 632, aucune forme éteinte ou isolée | `9120af2` (PAS le HEAD) | 2026-09-07T02:20:35Z | local, session Claude, chaîne verify complète (verify-full-21.log, R47 — passage propre après les correctifs de la revue hostile ; verify-full-20.log avait rougi une fois sur clics, #418 hors tranche, non lié aux fichiers de cette tranche, F13 docs/CHASSE.md) — borne haute : mtime du journal (fin de chaîne), pas d'horodatage propre à cette étape |
| `npm run langue` | vert — 0 chaîne d'écran hors catalogue, 0 libellé en dur dans un service | `9120af2` (PAS le HEAD) | 2026-09-07T02:20:35Z | local, session Claude, chaîne verify complète (verify-full-21.log, R47 — passage propre après les correctifs de la revue hostile ; verify-full-20.log avait rougi une fois sur clics, #418 hors tranche, non lié aux fichiers de cette tranche, F13 docs/CHASSE.md) — borne haute : mtime du journal (fin de chaîne), pas d'horodatage propre à cette étape |
| `npm run langue:epreuve` | vert — tous les cas connus mauvais dénoncés | `9120af2` (PAS le HEAD) | 2026-09-07T02:20:35Z | local, session Claude, chaîne verify complète (verify-full-21.log, R47 — passage propre après les correctifs de la revue hostile ; verify-full-20.log avait rougi une fois sur clics, #418 hors tranche, non lié aux fichiers de cette tranche, F13 docs/CHASSE.md) — borne haute : mtime du journal (fin de chaîne), pas d'horodatage propre à cette étape |
| `npm run lectures` | vert — 0 lecture perdue sur 1681 chemins figés dans 86 écrans | `9120af2` (PAS le HEAD) | 2026-09-07T02:20:35Z | local, session Claude, chaîne verify complète (verify-full-21.log, R47 — passage propre après les correctifs de la revue hostile ; verify-full-20.log avait rougi une fois sur clics, #418 hors tranche, non lié aux fichiers de cette tranche, F13 docs/CHASSE.md) — borne haute : mtime du journal (fin de chaîne), pas d'horodatage propre à cette étape |
| `npm run lectures:epreuve` | vert | `9120af2` (PAS le HEAD) | 2026-09-07T02:20:35Z | local, session Claude, chaîne verify complète (verify-full-21.log, R47 — passage propre après les correctifs de la revue hostile ; verify-full-20.log avait rougi une fois sur clics, #418 hors tranche, non lié aux fichiers de cette tranche, F13 docs/CHASSE.md) — borne haute : mtime du journal (fin de chaîne), pas d'horodatage propre à cette étape |
| `npm run parcours` | vert | `9120af2` (PAS le HEAD) | 2026-09-07T02:20:35Z | local, session Claude, chaîne verify complète (verify-full-21.log, R47 — passage propre après les correctifs de la revue hostile ; verify-full-20.log avait rougi une fois sur clics, #418 hors tranche, non lié aux fichiers de cette tranche, F13 docs/CHASSE.md) — borne haute : mtime du journal (fin de chaîne), pas d'horodatage propre à cette étape |
| `npm run parcours:epreuve` | vert | `9120af2` (PAS le HEAD) | 2026-09-07T02:20:35Z | local, session Claude, chaîne verify complète (verify-full-21.log, R47 — passage propre après les correctifs de la revue hostile ; verify-full-20.log avait rougi une fois sur clics, #418 hors tranche, non lié aux fichiers de cette tranche, F13 docs/CHASSE.md) — borne haute : mtime du journal (fin de chaîne), pas d'horodatage propre à cette étape |
| `npm run screens` | vert — 87 routes ouvertes, 0 échec | `9120af2` (PAS le HEAD) | 2026-09-07T02:20:35Z | local, session Claude, chaîne verify complète (verify-full-21.log, R47 — passage propre après les correctifs de la revue hostile ; verify-full-20.log avait rougi une fois sur clics, #418 hors tranche, non lié aux fichiers de cette tranche, F13 docs/CHASSE.md) — borne haute : mtime du journal (fin de chaîne), pas d'horodatage propre à cette étape |
| `npm run fumee` | vert — 51 route(s) ouvertes, 0 échec | `9120af2` (PAS le HEAD) | 2026-09-07T02:20:35Z | local, session Claude, chaîne verify complète (verify-full-21.log, R47 — passage propre après les correctifs de la revue hostile ; verify-full-20.log avait rougi une fois sur clics, #418 hors tranche, non lié aux fichiers de cette tranche, F13 docs/CHASSE.md) — borne haute : mtime du journal (fin de chaîne), pas d'horodatage propre à cette étape |
| `npm run densite` | vert — 77 écrans mesurés, 0 au-delà de 5 actions primaires, 108 champs à taper, docs/DENSITE.md écrit | `9120af2` (PAS le HEAD) | 2026-09-07T02:20:35Z | local, session Claude, chaîne verify complète (verify-full-21.log, R47 — passage propre après les correctifs de la revue hostile ; verify-full-20.log avait rougi une fois sur clics, #418 hors tranche, non lié aux fichiers de cette tranche, F13 docs/CHASSE.md) — borne haute : mtime du journal (fin de chaîne), pas d'horodatage propre à cette étape |
| `npm run clics` | vert — 208 étapes conduites, 0 échec, 319 clics comptés sur 45 gestes, sonde d'hydratation : aucun incident, garde du parcours : 193 station(s) figée(s) vérifiée(s) | `9120af2` (PAS le HEAD) | 2026-09-07T02:20:35Z | local, session Claude, chaîne verify complète (verify-full-21.log, R47 — passage propre après les correctifs de la revue hostile ; verify-full-20.log avait rougi une fois sur clics, #418 hors tranche, non lié aux fichiers de cette tranche, F13 docs/CHASSE.md) — borne haute : mtime du journal (fin de chaîne), pas d'horodatage propre à cette étape |
| `npm run visuel` | vert — 312 vues regardées, 0 défaut | `9120af2` (PAS le HEAD) | 2026-09-07T02:20:35Z | local, session Claude, chaîne verify complète (verify-full-21.log, R47 — passage propre après les correctifs de la revue hostile ; verify-full-20.log avait rougi une fois sur clics, #418 hors tranche, non lié aux fichiers de cette tranche, F13 docs/CHASSE.md) — borne haute : mtime du journal (fin de chaîne), pas d'horodatage propre à cette étape |

**Non exécutées sur le HEAD** (à passer avant de dire « vert », règle 12) :

- `npm run db:reset` — dernière exécution sur `9120af2` le 2026-09-07T02:20:35Z : vert — base réinitialisée, migrations appliquées
- `npm run demo:seed` — dernière exécution sur `9120af2` le 2026-09-07T02:20:35Z : vert — monde de démonstration reconstruit (13 exceptions, 8 deviations, 3 workpapers, 289 events)
- `npx tsc --noEmit` — dernière exécution sur `9120af2` le 2026-09-07T02:20:35Z : vert — aucune erreur de type
- `npx vitest run` — dernière exécution sur `9120af2` le 2026-09-07T02:20:35Z : vert — 102 fichier(s) de test, 860 test(s) passés (860)
- `npm run gardes` — dernière exécution sur `9120af2` le 2026-09-07T02:20:35Z : vert — docs/GUARDS.md à jour, 43 garde(s)
- `npm run semeur` — dernière exécution sur `9120af2` le 2026-09-07T02:20:35Z : vert — docs/SEMEUR_VS_CHEMIN.md à jour avec le registre
- `npm run plancher` — dernière exécution sur `9120af2` le 2026-09-07T02:20:35Z : vert — 860 test(s) collecté(s) par vitest, plancher 632, aucune forme éteinte ou isolée
- `npm run langue` — dernière exécution sur `9120af2` le 2026-09-07T02:20:35Z : vert — 0 chaîne d'écran hors catalogue, 0 libellé en dur dans un service
- `npm run langue:epreuve` — dernière exécution sur `9120af2` le 2026-09-07T02:20:35Z : vert — tous les cas connus mauvais dénoncés
- `npm run lectures` — dernière exécution sur `9120af2` le 2026-09-07T02:20:35Z : vert — 0 lecture perdue sur 1681 chemins figés dans 86 écrans
- `npm run lectures:epreuve` — dernière exécution sur `9120af2` le 2026-09-07T02:20:35Z : vert
- `npm run parcours` — dernière exécution sur `9120af2` le 2026-09-07T02:20:35Z : vert
- `npm run parcours:epreuve` — dernière exécution sur `9120af2` le 2026-09-07T02:20:35Z : vert
- `npm run screens` — dernière exécution sur `9120af2` le 2026-09-07T02:20:35Z : vert — 87 routes ouvertes, 0 échec
- `npm run fumee` — dernière exécution sur `9120af2` le 2026-09-07T02:20:35Z : vert — 51 route(s) ouvertes, 0 échec
- `npm run densite` — dernière exécution sur `9120af2` le 2026-09-07T02:20:35Z : vert — 77 écrans mesurés, 0 au-delà de 5 actions primaires, 108 champs à taper, docs/DENSITE.md écrit
- `npm run clics` — dernière exécution sur `9120af2` le 2026-09-07T02:20:35Z : vert — 208 étapes conduites, 0 échec, 319 clics comptés sur 45 gestes, sonde d'hydratation : aucun incident, garde du parcours : 193 station(s) figée(s) vérifiée(s)
- `npm run visuel` — dernière exécution sur `9120af2` le 2026-09-07T02:20:35Z : vert — 312 vues regardées, 0 défaut
