...
Mesure prise sur le commit `c017501 + arbre de travail modifié (mesure prise avant le commit qui la publie)`, build `qOMlOeSTfrQzyHLR4a8Ct`.
...
| `/eng/[id]/sampling` | 4 | 0 | 54 | 0 | Altiverre FY2025 — Audit légal (NEP) |
...
| `/eng/[id]/sampling (SOX)` | 3 | 0 | 0 | 0 | Altiverre FY2025 — SOX 404 component (PCAOB/COSO) |
| `/eng/[id]/testing` | 3 | 1 | 2 | 0 | Altiverre FY2025 — Audit légal (NEP) |
| `/eng/[id]/testing (SOX)` | 3 | 2 | 0 | 0 | Altiverre FY2025 — SOX 404 component (PCAOB/COSO) |
| `/` | 2 | 1 | 0 | 11 | Engagements |
| `/eng/[id]/imports` | 2 | 0 | 0 | 11 | Altiverre FY2025 — Audit légal (NEP) |
| `/eng/[id]/imports (SOX)` | 2 | 0 | 0 | 11 | Altiverre FY2025 — SOX 404 component (PCAOB/COSO) |
...
| `/eng/[id]/poste/[code]` | 2 | 0 | 7 | 1 | Altiverre FY2025 — Audit légal (NEP) |
| `/eng/[id]/poste/[code]/detail-compte` | 2 | 0 | 0 | 0 | Altiverre FY2025 — Audit légal (NEP) |
...
| `/eng/[id]/circularisations` | 1 | 3 | 2 | 0 | Altiverre FY2025 — Audit légal (NEP) |
...
| `/eng/[id]/risk` | 1 | 0 | 23 | 0 | Altiverre FY2025 — Audit légal (NEP) |
...
| `/portal/[token]/[rid]` | 1 | 0 | 46 | 0 | R-008 — Justificatifs — contrôle du chiffre d'affaires (sélection) |
| `/eng/[id]` | 0 | 0 | 14 | 0 | Altiverre FY2025 — Audit légal (NEP) |
| `/eng/[id] (SOX)` | 0 | 0 | 14 | 0 | Altiverre FY2025 — SOX 404 component (PCAOB/COSO) |
...
| `/eng/[id]/analytique` | 0 | 0 | 0 | 0 | Altiverre FY2025 — Audit légal (NEP) |
| `/eng/[id]/analytique (SOX)` | 0 | 0 | 0 | 0 | Altiverre FY2025 — SOX 404 component (PCAOB/COSO) |
...
| `/eng/[id]/grand-livre` | 0 | 0 | 0 | 0 | Altiverre FY2025 — Audit légal (NEP) |
| `/eng/[id]/grand-livre (SOX)` | 0 | 0 | 0 | 0 | Altiverre FY2025 — SOX 404 component (PCAOB/COSO) |
...
| `/eng/[id]/loop` | 0 | 0 | 9 | 0 | Altiverre FY2025 — Audit légal (NEP) |
...
| `/eng/[id]/programme` | 0 | 0 | 74 | 0 | Altiverre FY2025 — Audit légal (NEP) |
