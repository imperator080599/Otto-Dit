...
## I. Deux ajouts au plan d'autonomie (2026-09-06) — à traiter APRÈS le Lot 2

*Mandat du fondateur, en session : « Deux ajouts au plan, à inscrire au registre et à traiter
après le Lot 2. » Consignés ici avant d'être repris — rien ne sort du registre (règle 23).
Aucun des deux n'est commencé.*

| id | idée | état | raison / où ça s'accroche |
|---|---|---|---|
