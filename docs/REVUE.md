...
**NON OBSERVÉE**
Manque : non commencé — clics sort en EXIT=1 (#418 ×4) et casse le && de verify avant visuel ; le figé du parcours est impossible ; l'hypothèse H (course hydratation) n'a jamais été éprouvée. Exit critère de la Phase 0 (ouvre Phase 1).
