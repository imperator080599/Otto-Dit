...
export const SECTIONS: SectionSemeur[] = [
  ...
  },
  {
    ...
    objets: [
      ...
      { objet: 'occurrences importées (importInstances)', semeur: 'part2.ts:64', cheminHumain: 'rcm/[cid]/page.tsx:100,255', clique: null, etat: 'non_prouve' },
      { objet: 'pièce d’exécution de contrôle déposée (uploadControlEvidence)', semeur: 'part2.ts:73 (appelée depuis 145, 162)', cheminHumain: 'rcm/[cid]/page.tsx (dépôt sur demande d’échantillon)', clique: null, etat: 'non_prouve' },
      { objet: 'échantillon d’attributs tiré ET demande de preuves envoyée (drawAttributeSample + approveSend, DEUX instructions du MÊME drawAction)', semeur: 'part2.ts:143-144', cheminHumain: 'rcm/[cid]/page.tsx:115-116,257 (un seul bouton, un seul geste)', clique: null, etat: 'non_prouve',
      ...
      { objet: 'extraction du contrôle exécuté (extractAll/verifyExtraction, SOX)', semeur: 'part2.ts:146,148,163,165', cheminHumain: 'testing/page.tsx:67 (même service, dossier SOX)', clique: null, etat: 'non_prouve' },
      { objet: 'test d’efficacité exécuté (runAttributeTesting)', semeur: 'part2.ts:150,167', cheminHumain: 'rcm/[cid]/page.tsx:120', clique: null, etat: 'non_prouve' },
      { objet: 'extension à la population complète (extendToFullPopulation)', semeur: 'part2.ts:156', cheminHumain: null, clique: null, etat: 'decor',
        note: 'aucun appelant nulle part hors part2.ts et sa propre définition (sox.ts:850)' },
      { objet: 'déficience proposée (proposeDeficiency)', semeur: 'part2.ts:180', cheminHumain: 'rcm/[cid]/page.tsx:143,315', clique: null, etat: 'non_prouve' },
      { objet: 'déficience décidée (decideDeficiency)', semeur: 'part2.ts:187', cheminHumain: 'rcm/[cid]/page.tsx:155', clique: null, etat: 'non_prouve' },
      { objet: 'papier OE rédigé (draftOeWorkpaper)', semeur: 'part2.ts:189', cheminHumain: 'rcm/[cid]/page.tsx:167,324', clique: null, etat: 'non_prouve' },
    ],
  },
  {
