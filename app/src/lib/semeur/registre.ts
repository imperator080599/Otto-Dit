...
export const SECTIONS: SectionSemeur[] = [
  ...
  },
  {
    ...
    objets: [
      ...
      { objet: 'statut du walkthrough DI (setDiStatus)', semeur: 'part2.ts:121', cheminHumain: 'rcm/page.tsx:42', clique: null, etat: 'non_prouve' },
      { objet: 'enregistrement vidéo du walkthrough attaché (attacherWalkthrough)', semeur: 'part2.ts:118 (mandat contrôle interne, 2026-09-08)', cheminHumain: 'rcm/[cid]/page.tsx (attacherWalkthroughAction)', clique: null, etat: 'non_prouve',
      ...
      { objet: 'tâche du walkthrough documentée (ajouterTacheControle)', semeur: 'part2.ts:119', cheminHumain: 'rcm/[cid]/page.tsx (ajouterTacheAction)', clique: null, etat: 'non_prouve' },
      { objet: 'procédure de tâche documentée hors inquiry — CTRL-01 (documenterProcedureTache)', semeur: 'part2.ts:120', cheminHumain: 'rcm/[cid]/page.tsx (documenterProcedureAction)', clique: null, etat: 'non_prouve' },
      ...
      { objet: 'occurrences importées (importInstances)', semeur: 'part2.ts:55', cheminHumain: 'rcm/[cid]/page.tsx:100,255', clique: null, etat: 'non_prouve' },
      { objet: 'pièce d’exécution de contrôle déposée (uploadControlEvidence)', semeur: 'part2.ts:72 (appelée depuis 126, 143)', cheminHumain: 'rcm/[cid]/page.tsx (dépôt sur demande d’échantillon)', clique: null, etat: 'non_prouve' },
      { objet: 'échantillon d’attributs tiré ET demande de preuves envoyée (drawAttributeSample + approveSend, DEUX instructions du MÊME drawAction)', semeur: 'part2.ts:124-125', cheminHumain: 'rcm/[cid]/page.tsx:115-116,257 (un seul bouton, un seul geste)', clique: null, etat: 'non_prouve',
      ...
      { objet: 'extraction du contrôle exécuté (extractAll/verifyExtraction, SOX)', semeur: 'part2.ts:127,129,144,146', cheminHumain: 'testing/page.tsx:67 (même service, dossier SOX)', clique: null, etat: 'non_prouve' },
      { objet: 'test d’efficacité exécuté (runAttributeTesting)', semeur: 'part2.ts:131,148', cheminHumain: 'rcm/[cid]/page.tsx:120', clique: null, etat: 'non_prouve' },
      { objet: 'extension à la population complète (extendToFullPopulation)', semeur: 'part2.ts:137', cheminHumain: null, clique: null, etat: 'decor',
        note: 'aucun appelant nulle part hors part2.ts et sa propre définition (sox.ts:645)' },
      { objet: 'déficience proposée (proposeDeficiency)', semeur: 'part2.ts:161', cheminHumain: 'rcm/[cid]/page.tsx:143,315', clique: null, etat: 'non_prouve' },
      { objet: 'déficience décidée (decideDeficiency)', semeur: 'part2.ts:168', cheminHumain: 'rcm/[cid]/page.tsx:155', clique: null, etat: 'non_prouve' },
      { objet: 'papier OE rédigé (draftOeWorkpaper)', semeur: 'part2.ts:170', cheminHumain: 'rcm/[cid]/page.tsx:167,324', clique: null, etat: 'non_prouve' },
    ],
  },
  {
