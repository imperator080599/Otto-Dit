...
export const SECTIONS: SectionSemeur[] = [
  ...
  },
  {
    ...
    objets: [
      ...
      { objet: 'statut du walkthrough DI (setDiStatus)', semeur: 'part2.ts:140', cheminHumain: 'rcm/page.tsx:42', clique: null, etat: 'non_prouve' },
      { objet: 'enregistrement vidéo du walkthrough attaché (attacherWalkthrough)', semeur: 'part2.ts:119 (mandat contrôle interne, 2026-09-08)', cheminHumain: 'rcm/[cid]/page.tsx (attacherWalkthroughAction)', clique: null, etat: 'non_prouve',
        note: 'domaine SOX entier hors du parcours cliqué (note ci-dessus, ligne 166-167) — même état que le reste de cette section, pas une régression neuve' },
      { objet: 'tâche du walkthrough documentée (ajouterTacheControle)', semeur: 'part2.ts:120', cheminHumain: 'rcm/[cid]/page.tsx (ajouterTacheAction)', clique: null, etat: 'non_prouve' },
      { objet: 'procédure de tâche documentée hors inquiry — CTRL-01 (documenterProcedureTache)', semeur: 'part2.ts:121', cheminHumain: 'rcm/[cid]/page.tsx (documenterProcedureAction)', clique: null, etat: 'non_prouve' },
      { objet: 'facteur de design documenté, les quatre — CTRL-02 (documenterFacteurDesign)', semeur: 'part2.ts:131-138 (mandat contrôle interne, 2026-09-08, tranche 2)', cheminHumain: 'rcm/[cid]/page.tsx (documenterFacteurAction)', clique: null, etat: 'non_prouve',
        note: 'domaine SOX entier hors du parcours cliqué (note ci-dessus) — même état que le reste de cette section, pas une régression neuve' },
      { objet: 'IUC déclarée (utilisée ou non) — CTRL-03 (declarerIuc)', semeur: 'part2.ts:139 (mandat contrôle interne, 2026-09-08, tranche 2)', cheminHumain: 'rcm/[cid]/page.tsx (declarerIucAction)', clique: null, etat: 'non_prouve',
        note: 'les deux contrôles cyclés (C-BR-01, C-REV-01) déclarent utilisee=false (manuels d’après le RCM) — documenterIucPreuve (les preuves d’exactitude/exhaustivité) n’est donc appelé par AUCUN fichier du semeur, hors du périmètre de ce registre (règle du fichier, ligne 28) ; vérifié cliqué à la main, en direct, sur un build de production (script jetable, supprimé) — 4/4 facteurs et 2/2 preuves confirmés persistés par une navigation fraîche.' },
